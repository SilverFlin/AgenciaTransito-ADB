...
public class AgregarForm extends javax.swing.JFrame {
    ...
    private static final Logger LOG = Logger.getLogger(AgregarForm.class.getName());

    private final JFrame frmAnterior;

    public AgregarForm(JFrame frmAnterior) {
        initComponents();
    ...
    private javax.swing.JComboBox<Object> comboBoxNacionalidad;
